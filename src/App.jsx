    ...
    <div className="container">
      ...
      <div className="tab-content">
        ...
        <TabContent tabId="cartorio" activeTab={activeTab}>
          ...
          <iframe
            // URL de EMBED real, limpo de sintaxe HTML
        ...
        <TabContent tabId="recepcao" activeTab={activeTab}>
          ...
          {/* MAPA EMBUTIDO (IFRAME) */}
          <iframe
            // URL de EMBED real (o prefixo duplicado foi removido)
        ...
        {/* === ABA: CONFIRMAÇÃO (RSVP) === */}
        <TabContent tabId="rsvp" activeTab={activeTab}>
          <h2>Confirmação de Presença (RSVP)</h2>
          <p>
            Por favor, confirme sua presença até **23 de Dezembro de 2025**.
          </p>
          <RSVPForm />
        </TabContent>
